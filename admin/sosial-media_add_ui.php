        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Add Data Penghargaan</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item"><a href="sosial-media.php">Sosial Media</a></li>
                                <li class="breadcrumb-item active">Add Sosial Media</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Tambah Penghargaan</h3>
                                </div>
                            </div>
                            <!-- /.form-header -->
                            <!-- form start -->
                            <form action="action_add_sosial-media.php" method="POST">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Nama</label>
                                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Instagram, Facebook, ...">
                                    </div>
                                    <div class="form-group">
                                        <!-- <label>Link</label>
                                        <input type="text" class="form-control" id="link" name="link" placeholder="Masukkan url"> -->
                                        <label for="link" class="form-label">Link</label>
                                        <textarea class="form-control" name="link" id="link" rows="4" placeholder="Masukkan url"></textarea>
                                    </div>
                                    <!-- /.card-body -->
