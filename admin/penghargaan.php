                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group btn-group-sm">
                              ...
                              <a onclick="return confirm('Anda Yakin?')" href="action_delete_penghargaan.php?id_penghargaan=<?php echo $result['id_penghargaan'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                            </div>
                          </td>
                        </tr>
                      <?php } ?>
