    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Ubah Data Testimoni</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              ...
              <form action="action_edit_testimoni.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="username" class="form-control" id="narasumber" name="narasumber" value="<?= $result['narasumber'] ?>">
                  </div>
                  <div class="form-group">
                    <label>Profesi</label>
                    <input type="username" class="form-control" id="narasumber_profesi" name="narasumber_profesi" value="<?= $result['narasumber_profesi'] ?>">
                  </div>
                  <div class="form-group">
                    <label>Testimoni</label>
                    <textarea class="form-control" rows="3" placeholder="Masukkan testimoni konsumen disini" name="testimoni"><?= $result['testimoni'] ?></textarea>
                  </div>
                  <div class="form-group">
                    <label>Rating</label>
                    <select class="form-control" name="rating">
                      <option value="5" <?php echo $result['rating'] == '5' ? 'selected' : ''; ?>>5</option>
                      <option value="4" <?php echo $result['rating'] == '4' ? 'selected' : ''; ?>>4</option>
                      <option value="3" <?php echo $result['rating'] == '3' ? 'selected' : ''; ?>>3</option>
                      <option value="2" <?php echo $result['rating'] == '2' ? 'selected' : ''; ?>>2</option>
                      <option value="1" <?php echo $result['rating'] == '1' ? 'selected' : ''; ?>>1</option>
                    </select>
                  </div>
                  <div class="form-group">
