                ...
                <div class="card-body">
                  <div class="form-group">
                      ...
                      <select class="form-control" id="kategori" name="kategori">
                        <option value="Event"<?php echo $result['kategori']=='Event'? 'selected':'';?>>Event</option>
                        <option value="Loker"<?php echo $result['kategori']=='Loker'? 'selected':'';?>>Loker</option>
                        <option value="Pengumuman"<?php echo $result['kategori']=='Pengumuman'? 'selected':'';?>>Pengumuman</option>
                      </select>
                  </div>
                  <div class="form-group">
                      <label>Judul</label>
